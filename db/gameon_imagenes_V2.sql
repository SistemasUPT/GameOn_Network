...
INSERT INTO `areas_deportivas` (`id`, `institucion_deportiva_id`, `deporte_id`, `nombre_area`, `descripcion`, `capacidad_jugadores`, `tarifa_por_hora`, `estado`, `imagen_area`, `creado_en`) VALUES
	...
	(20, 1, 3, 'Cancha de Básquet Techada', 'Cancha de básquet con tableros oficiales', 10, 55.00, 'activa', 'https://ibb.co/Z18mX5S7', '2025-06-16 21:44:21'),
	(21, 2, 1, 'Campo de Fútbol Los Andes', 'Campo de fútbol con césped natural y graderías', 22, 70.00, 'activa', 'https://ibb.co/27J1vDgX', '2025-06-16 21:44:51'),
	(22, 2, 3, 'Cancha de Básquet Principal', 'Cancha de básquet techada con marcador electrónico', 10, 60.00, 'activa', 'https://ibb.co/HD2nYJG3', '2025-06-16 21:44:51'),
	(23, 2, 3, 'Cancha de Básquet Entrenamiento', 'Cancha auxiliar para entrenamientos', 10, 45.00, 'activa', 'https://ibb.co/wZyhH1kh', '2025-06-16 21:44:51'),
	(24, 2, 2, 'Cancha de Vóley Los Andes', 'Cancha de vóley con piso de cemento pulido', 12, 35.00, 'activa', 'https://ibb.co/CspvLrY8', '2025-06-16 21:44:51'),
...
-- Volcando datos para la tabla gameon.usuarios_deportistas: ~5 rows (aproximadamente)
INSERT INTO `usuarios_deportistas` (`id`, `nombre`, `apellidos`, `email`, `telefono`, `fecha_nacimiento`, `genero`, `nivel_habilidad`, `username`, `password`, `estado`, `creado_en`) VALUES
	...
	(6, 'a', 'a', 'ac2022074258@virtual.upt.pe', 'a', '2025-06-05', 'Masculino', '', 'a', '$2y$10$QAZ0NaBlkPl0GvGg96qcz.32vS5Fb0kzk7OVAKz8zEq5QEnwRd54G', 1, '2025-06-18 06:23:51');
